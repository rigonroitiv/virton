...
import {
  getAllBuildingAndApartmentsData,
  ...
  return (
    <TableContainer style={{ overflow: "auto", marginTop: "5px" }}>
      <Table stickyHeader>
        ...
        <TableBody>
          {data?.map((building) =>
            building.apartmentList
              .filter(
                (v, i, a) =>
                  a.map((val) => val.apartmentId).indexOf(v.apartmentId) === i
              )
              .map((apartment, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell sx={{ pl: "5px", py: "1px" }}>
                    {parseFloat(apartment.square).toFixed(2)} m2
                  </TableCell>
                  <TableCell sx={{ pl: "5px", py: "1px" }}>
                  ...
                  <TableCell sx={{ pl: "5px", py: "1px" }}>
                    {apartment.isSold ? "Shitur" : "Jo E Shitur"}
                  </TableCell>
                  <TableCell sx={{ pl: "5px", py: "1px" }}>
                    <Tooltip title="Edit">
                      <IconButton
